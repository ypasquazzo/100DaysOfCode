...
Original file is located at
    https://colab.research.google.com/drive/1dVfLFoF8hMfsrO5KYE-XSvrj-gFVWLiw
...
(df.groupby(['TAG']).sum()['POSTS'].idxmax(), df.groupby(['TAG']).sum()['POSTS'].max())
...
(df.groupby(['TAG']).count()['DATE'].idxmin(), df.groupby(['TAG']).count()['DATE'].min())
